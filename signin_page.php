        ...
        <div class="row mt-5">
            ...
            <div class="col-sm mt-5 text-center">               
                ...
                <form name="member" method="post" action="member_insert.php">
                    ...
                    <label class="custom-control-label" for="jb-checkbox">개인정보 수집 및 이용에 동의합니다<div class="text-center"></div></label><br><br>    
                             <!--제출 버튼-->
                    <div style="cursor:pointer" onclick="check_input()" class="mt-5"><p>회원가입 <div class="text-center"></p></div>
                </form>       
            </div>           
        </div>
        <div class="col-sm mt-5">         
