...
?>
    ...
    <div class="container"> 
        <div class="row">                
            ...
            <label class="ml-4 custom-control-label text-center" for="jb-checkbox">개인정보 수집 및 이용에 동의합니다</label> 
                     <!--제출 버튼-->
            <div style="cursor:pointer" onclick="check_input()" class="mt-5 text-center"><p>회원가입</p></div>
                </div>
            <div class="col">                
                </div>
        </div>
