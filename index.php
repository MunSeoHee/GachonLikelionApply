                ...
                <div class="faq container-fluid">
                    ...
                    <ul class="faqBody ml-5 p-0">
                        <li class="article" id="a1">
                            <p class="q row text-body border-bottom p-3"><a href="#a1">지원일정을 알려주세요</a></p>
                            <p class="a container-fluid row bg-light text-muted p-3" style="font-size:90%">
                        ...
                        <li class="article" id="a2">
                            <p class="q row text-body"><a href="#a2">지원자격을 알고싶어요</a></p>
                        ...
                        <li class="article" id="a3">
                            <p class="q row text-body"><a href="#a3">활동 일정을 알고싶어요</a></p>
                            <p class="a container-fluid row bg-light text-muted">
